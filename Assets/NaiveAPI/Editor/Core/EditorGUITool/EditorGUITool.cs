...
namespace NaiveAPI
{
    namespace EditorTool
    {
        public static class EditorGUITool
        {
            ...
            public static void ColorRegion(bool isSuccess, UnityEngine.Color success, UnityEngine.Color fail, Action action) { ColorRegion(isSuccess ? success : fail, action); }
            ...
            /// <summary>
            /// <code>
            /// EditorGUITool.DisableGroub(true, ( ) => {
            /// <br/>    "your code"
            /// });
            /// </code>
            /// </summary>
            ...
            public static Rect DividerLine(UnityEngine.Color color, float height = 5, float xBleed = 5) { return DividerLine("", color, color, height, xBleed); }
            ...
            public static bool TextureButton(Rect position,bool isTextureA,Texture2D textureA, Texture2D textureB)
            {
                GUI.DrawTexture(position, isTextureA? textureA:textureB);
                return GUI.Button(position,"",GUIStyle.none);
            }
